  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 lg:px-8 z-10 sticky top-0">
      <div className="flex items-center gap-4">
        ...
        <h2 className="text-primary text-lg font-bold tracking-tight hidden sm:block">
          Dashboard
        </h2>
      </div>
      ...
      <div className="flex-1 max-w-xl mx-4 lg:mx-12">
        <div className="relative group">
          ...
          <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
            <span className="text-xs text-slate-400 border border-slate-300 rounded px-1.5 py-0.5 hidden lg:block">
              ⌘K
            </span>
          </div>
        </div>
